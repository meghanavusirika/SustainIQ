...
exports.predictESGTrend = predictESGTrend;
exports.generateMockHistoricalData = generateMockHistoricalData;
function predictESGTrend(historicalData, yearsToPredict = 3) {
...
function generateMockHistoricalData(companyId, baseScore = 75) {
    const data = [];
